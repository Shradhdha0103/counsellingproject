...
<div class="login-form">    
    <form action="{{ route('register') }}" method="POST">
    	...
    	<h4 class="modal-title">Register to Your Account/Create your profile</h4>
        ...
        <div class="form-group">
            <input type="password_confirmation" id="password_confirmation" name="password_confirmation" class="form-control" placeholder="Password Confirmation" required="required">
        </div>
